...
var saveChannels = "CODE:";
    ...
    saveChannels+= "FILEDELETE NAME=C:\\Users\\Administrator\\Downloads\\Videos.csv\n";
    saveChannels+= "WAIT SECONDS = 1\n";
    saveChannels+= "URL GOTO=https://www.dropbox.com/s/wd39d7pqko6r90l/Videos.csv?dl=1&pv=1\n";
    saveChannels+= "WAIT SECONDS = 1\n";
